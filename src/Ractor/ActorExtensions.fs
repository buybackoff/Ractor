...
type Actors() =
    ...
    static member ContinueWith<'Task, 'TResult1, 'TResult2>
        (this : Actor<'Task, 'TResult1>, 
            continuation : Actor<'TResult1, 'TResult2>) : Actor<'Task, 'TResult2> =
                ...
                let computation : Message<'Task> * string -> Task<Message<'TResult2>> = 
    ...
    static member ParallelWith(this : Actor<'Task, 'TResult>, second : Actor<'Task2, 'TResult2>) 
            : Actor<'Task * 'Task2, 'TResult * 'TResult2> =
                ...
                let computation : Message<'Task * 'Task2> * string -> Task<Message<'TResult * 'TResult2>> = 
                    fun (inMessage, resultId) ->
                        task {
                            ...
                            let! child1 = actor1.PostAndGetResult(envelope1).WithTimeout(timeout)
                            let! child2 = actor2.PostAndGetResult(envelope2).WithTimeout(timeout)
                            let r1 : Message<'TResult> = child1
                            let r2 : Message<'TResult2> = child2
...
//            actor.Post(message)
//        
//        member this.PostAsync<'Task, 'TResult>( message : 'Task) : Task<Guid> =
//            let actor = ActorImpl<'Task, 'TResult>.Instance(this)
...
//            actor.PostAndGetResult(message)
//        
//        member this.PostAndGetResultAsync<'Task, 'TResult>( message : 'Task) : Task<'TResult> =
//            let actor = ActorImpl<'Task, 'TResult>.Instance(this)
...
//            actor.TryPostAndGetResult(message, &result)
//        
//        member this.TryPostAndGetResultAsync<'Task, 'TResult>( message : 'Task) : Task<bool*'TResult> =
//            let actor = ActorImpl<'Task, 'TResult>.Instance(this)
